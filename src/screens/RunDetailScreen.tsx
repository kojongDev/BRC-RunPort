...
import {formatDistance, formatDuration, formatPace, formatCalories, formatDateTime} from '@utils/formatters';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.dateSection}>
          <Text style={styles.dateText}>{formatDateTime(new Date(run.started_at))}</Text>
        </View>
        ...
        <View style={styles.statsSection}>
          <View style={styles.mainStat}>
            ...
            <Text style={styles.mainStatValue}>{formatDistance(run.total_distance)}</Text>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              ...
              <Text style={styles.statCardValue}>{formatDuration(run.total_duration)}</Text>
            </View>

            <View style={styles.statCard}>
              <Text style={styles.statCardLabel}>평균 페이스</Text>
              <Text style={styles.statCardValue}>{formatPace(run.avg_pace)}</Text>
            </View>

            <View style={styles.statCard}>
              <Text style={styles.statCardLabel}>칼로리</Text>
              <Text style={styles.statCardValue}>{formatCalories(run.calories)}</Text>
            </View>
          </View>
        </View>
